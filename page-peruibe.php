			...
			<?php if ( have_posts() ) : while ( have_posts() ) : the_post();    
			 ...
			 endwhile; endif; ?>
				...
				<div id="segunda-linha">			
					...
					<div id="noticias-municipios-query">
					<a class="query-noticias" href="<?php echo home_url( '/category/noticias/de-peruibe' ); ?>"><h1 class="title-query-link">Not&iacute;cias</h1></a>
					<?php
					//Adiciona o query de Noticias de Peruibe
					 get_template_part('loop-peruibe');
					?>
					</div>
