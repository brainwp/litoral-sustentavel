...
<div id="">
	<div id="img-cabecalho" class="container">
		...
		<div id="logo-single" class="col-md-6">
			<a href="<?php echo get_site_url(); ?>" id="equipe-header-logo">
				<img id="logo-home" src="<?php echo get_stylesheet_directory_uri();?>/imagens/logo.png" align="center">
			</a>
		</div>
		<div class="col-md-1"></div>
	</div>
...
</header><!-- .equipe-header-title col-md-12 -->
<?php endif;?>